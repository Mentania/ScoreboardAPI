...
import de.tempoo50.system.utils.ScoarManager;
import de.tempoo50.system.utils.ScoreReflection;
...
public class ScoreboardAPI extends ScoarManager<String> {
    ...
    static {
        try {
            ...
            Class<?> craftChatMessageClass = ScoreReflection.obcClass("util.CraftChatMessage");
